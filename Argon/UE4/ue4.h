...
//inline bool IsInLobby(); // Function FortniteGame.FortMatchmakingContext.IsInLobby // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x16b4ee8
inline bool (*IsCharacterCustomizationLoadingCompleted)();
